...
foreach ($teams as $team) {
    ...
    // 2. Chercher les informations des deux équipes pour chaque match.
    ...
    // Ici, nous supposons que vous avez défini des fonctions pour calculer avgTotalScore, avgMID, avgATK, avgDEF, et avgGK.
    // Ces fonctions prennent en entrée une équipe et renvoient la moyenne de la statistique correspondante.
