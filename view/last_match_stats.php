    ...
    <div class="lastmatchcontainer">
        <div class="lastmatch" id="lastteamA">
            ...
            <div class="lastdomination">
                ...
                <div class="statnumber"><?php echo htmlspecialchars($lastMatch['dominationA'], ENT_QUOTES, 'UTF-8'); ?> %</div>
            </div>
            <div class="lastoccasion">
                <div class="stattype">Occasions</div>
                <div class="statnumber"><?php echo htmlspecialchars($lastMatch['occasionA'], ENT_QUOTES, 'UTF-8'); ?></div>
            </div>
            <div class="lasttir">
                <div class="stattype">Tirs</div>
                <div class="statnumber"><?php echo htmlspecialchars($lastMatch['tirA'], ENT_QUOTES, 'UTF-8'); ?></div>
            </div>
            <div class="lastscore">
                <div class="stattype">But(s)</div>
                <div class="statnumber"><?php echo htmlspecialchars($lastMatch['scoreA'], ENT_QUOTES, 'UTF-8'); ?></div>
            </div>
        </div>
        ...
        <div class="lastmatch" id="lastteamB">
            ...
            <div class="lastdomination">
                <div class="stattype">Domination</div>
                <div class="statnumber"><?php echo htmlspecialchars($lastMatch['dominationB'], ENT_QUOTES, 'UTF-8'); ?> %</div>
            </div>
            <div class="lastoccasion">
                <div class="stattype">Occasions</div>
                <div class="statnumber"><?php echo htmlspecialchars($lastMatch['occasionB'], ENT_QUOTES, 'UTF-8'); ?></div>
            </div>
            <div class="lasttir">
                <div class="stattype">Tirs</div>
                <div class="statnumber"><?php echo htmlspecialchars($lastMatch['tirB'], ENT_QUOTES, 'UTF-8'); ?></div>
            </div>
            <div class="lastscore">
                <div class="stattype">But(s)</div>
                <div class="statnumber"><?php echo htmlspecialchars($lastMatch['scoreB'], ENT_QUOTES, 'UTF-8'); ?></div>
            </div>
        </div>
    </div>
    <div class="classcontainer">
        <a class="voirclass" href="classement.php">classement</a>
    </div>
